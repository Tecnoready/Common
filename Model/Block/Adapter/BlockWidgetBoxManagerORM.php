 ...
 */
class WidgetBoxManagerORM extends BlockWidgetBoxManager
{
    function find($id)
    {
    ...
    public function remove(\Tecnoready\Common\Model\Block\BlockWidgetBox $blockWidgetBox) 
    {
        $success = false;
    ...
    public function save(\Tecnoready\Common\Model\Block\BlockWidgetBox $blockWidgetBox,$andFlush = true)
    {
        $em = $this->getDoctrine()->getManager();
